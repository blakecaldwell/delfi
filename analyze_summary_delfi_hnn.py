...
import pickle
inference_file = open('/users/bcaldwe2/scratch/delfi/%s_%d_trained_summary_inference.pickle'%(params_input['sim_prefix'], pilot_samples), 'rb')
...
plt.savefig('/users/bcaldwe2/scratch/delfi/%s_%s_%s_ntrain_%d_%s_summary-posterior.png' % (params_input['sim_prefix'], exp_data_prefix, density, n_train, proposal))
...
plt.savefig('/users/bcaldwe2/scratch/delfi/%s_%s_ntrain_%d_summary-observation.png' % (params_input['sim_prefix'], exp_data_prefix, n_train))
