...
inference_file = open('/users/bcaldwe2/scratch/delfi/%s_%d_%s_%s_round%d_inference.pickle'%(params_input['sim_prefix'], pilot_samples, proposal, exp_data_prefix, prev_round), 'rb')
...
import pickle
with open('../scratch/delfi/%s_%d_%s_%s_round%d_trained_inference.pickle'%(params_input['sim_prefix'], pilot_samples, proposal, exp_data_prefix, res.round), 'wb') as inference_file:
